 ...
 */
@Composable
fun Header(model : IModel<*>, appState: bigLazyTable.controller.AppState<*>?, changeShowError: (Boolean) -> Unit){
 ...
 */
@Composable
private fun LanguageDropDownButton(model: IModel<*>, appState: bigLazyTable.controller.AppState<*>?){
    with(model){
        Column {
...
@Composable
private fun DropdownElement(model: IModel<*>, language: String, index: Int, selectedIndex: MutableState<Int>, appState: bigLazyTable.controller.AppState<*>?){
    ...
    DropdownMenuItem(
        ...
        onClick = {
            appState?.apply { defaultTableModel.setCurrentLanguage(language) }
