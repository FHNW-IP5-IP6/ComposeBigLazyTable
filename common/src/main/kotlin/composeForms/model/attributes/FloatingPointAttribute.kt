...
/**
 *
 * The [FloatingPointAttribute] is an abstract attribute.the attribute for floating point numbers.
 * It is a subclass of [NumberAttribute]
 *
 ...
 */
abstract class FloatingPointAttribute <F,T,L> (
    //required parameters
    model                       : IModel<L>,
    label                       : L,
