...
class CommunicationITest {
    ...
    private fun initObjects(){
        ...
        //when
        attribute1 = StringAttribute<testLabels>(model!!,
            testLabels.TEST, value = "", validators = listOf(StringValidator(2,5)))
    ...
    fun testOnReceiveOutOfBoundsSelection(){
        ...
        try {
            model!!.setCurrentFocusedAttribute(IntegerAttribute(object: BaseModel<testLabels>(testLabels.TEST){
                override val displayedAttributesInTable: List<Attribute<*, *, *>>?
                    get() = TODO("Not yet implemented")
                override val id: Attribute<*, *, *>
                    get() = TODO("Not yet implemented")
