...
internal class IntegerAttributeTest: NumberAttributeTest<Int>() {
    ...
    override fun provideAttribute(model: BaseModel<Labels>, value: Int?): Attribute<*, Any, *> {
        return IntegerAttribute(model, Labels.TEST, value) as Attribute<*, Any, *>
    }
    override fun provideNumberAttribute(model: BaseModel<Labels>, value: Int?): NumberAttribute<*, Int, Labels> {
