...
internal class ShortAttributeTest : NumberAttributeTest<Short>(){
    ...
    override fun provideAttribute(model: BaseModel<Labels>, value: Short?): Attribute<*, Any, *> {
        return ShortAttribute(model, Labels.TEST, value) as Attribute<*, Any, *>
    }
    override fun provideNumberAttribute(model: BaseModel<Labels>, value: Short?): NumberAttribute<*, Short, Labels> {
