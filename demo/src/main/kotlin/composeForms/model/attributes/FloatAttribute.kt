...
/**
 *
 * The [FloatAttribute] is the attribute implementation of the type Float.
 * It is a subclass of the [FloatingPointAttribute].
 *
...
class FloatAttribute<L>(
    ...
    validators              : List<SemanticValidator<Float,L>>      = mutableListOf(),
